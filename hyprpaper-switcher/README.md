...
Pick a wallpaper from a grid and apply with hyprpaper. You can even generate a color palette from the wallpaper!
...
- One-tap to set wallpaper via `hyprpaper` on all or a single monitor
...
<img src="assets/settings.png" alt="Hyprpaper Switcher Settings" width="500" />
...
```
bind = SUPER CTRL, W, exec, vicinae vicinae://extensions/sovereign/hyprpaper-switcher/wpgrid
bind = SUPER SHIFT, W, exec, vicinae vicinae://extensions/sovereign/hyprpaper-switcher/wprandom
```
...
```
# Vicinae Matugen Theme for hyprpaper switcher
...
<img src="assets/split2.png" alt="HyprPaper Switcher split image settings" width="500" />

<img src="assets/split.png" alt="HyprPaper Switcher split images action" width="500" />
...
This will save the processed image to `~/.cache/vicinae/hyprpaper-switcher/postprod.jpg` which you can use as a wallpaper for rofi, lock screen, login screen, etc...
